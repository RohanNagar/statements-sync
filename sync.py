...
def move_file(stmt, parsedDate):
  ...
  print(f'  Moving statement at path {stmt.filePath} to path {newFilePath}')
...
def main(search_dir, dryrun=False):
  print(f'Starting sync of statements from folder {search_dir}...')
  filesMovedCount = 0
  ...
  print(f'\nFinished sync of statements. Files moved and renamed: {filesMovedCount}')
